...
function App() {
  ...
  const getThemeStyles = () => {
    ...
    if (isDarkMode) {
      ...
      [
        '--jdp-border-radius',
        '--jdp-input-border-radius',
        '--jdp-day-cell-border-radius',
        '--jdp-nav-button-border-radius',
        '--jdp-calendar-border-radius',
        '--jdp-input-border-width',
        '--jdp-font-size',
      ].forEach(prop => {
        if (baseTheme[prop]) {
      ...
      <div className="container">
        ...
        <div className="result">
          <p>
            ...
            <span id="jalali-result">{selectedJalali}</span>
          </p>
          <p>
            <strong>تاریخ میلادی معادل:</strong>{' '}
            <span id="gregorian-result">{selectedGregorian}</span>
          </p>
          <p>
            <strong>رویدادها:</strong> <span id="events-result">{selectedEvents}</span>
          </p>
        </div>
      </div>
    </div>
