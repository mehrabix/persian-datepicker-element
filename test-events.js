...
try {
  ...
  if (eventsData && Array.isArray(eventsData["Persian Calendar"])) {
    const afghanEvents = eventsData["Persian Calendar"]
      .filter(event => event.type === "Afghanistan");
  ...
  if (eventsData && Array.isArray(eventsData["Hijri Calendar"])) {
    const afghanEvents = eventsData["Hijri Calendar"]
      .filter(event => event.type === "Afghanistan");
  ...
  if (eventsData && Array.isArray(eventsData["nth weekday of month"])) {
    const afghanEvents = eventsData["nth weekday of month"]
      .filter(event => event.type === "Afghanistan");
