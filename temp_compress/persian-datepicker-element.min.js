...
class PersianDatePickerElement extends HTMLElement {
    ...
    seteventTypes(types) {
        if (typeof types === 'string') {
            ...
            if (types.toLowerCase() === 'all') {
                ...
                this.eventTypes = [...EventUtils.getEventTypes()]; // Get all available types
                return;
            }
    ...
    addHolidayInfo(dayElement, day) {
        ...
        if (EventUtils.isHoliday(this.jalaliMonth, day, this.eventTypes, this.includeAllTypes)) {
            dayElement.classList.add("holiday");
            // Add tooltip with event titles
            const events = EventUtils.getEvents(this.jalaliMonth, day, this.eventTypes, this.includeAllTypes);
            if (events.length > 0) {
    ...
    selectDate(day) {
        ...
        this.dispatchEvent(new CustomEvent("change", {
            detail: {
                ...
                isHoliday: EventUtils.isHoliday(this.jalaliMonth, day, this.eventTypes, this.includeAllTypes),
                events: events
            },
            bubbles: true
        }));
    ...
    isSelectedDateHoliday() {
        if (!this.selectedDate)
            return false;
        return EventUtils.isHoliday(this.selectedDate[1], this.selectedDate[2], this.eventTypes, this.includeAllTypes);
    }
    /**
    ...
    getSelectedDateEvents() {
        if (!this.selectedDate)
            return [];
        return [...EventUtils.getEvents(this.selectedDate[1], this.selectedDate[2], this.eventTypes, this.includeAllTypes)];
    }
    /**
...
if (hasCustomElements) {
    ...
    // Safely set global property
    if (isBrowser && window) {
        try {
            if (!window.hasOwnProperty('PersianDatePickerElement')) {
            ...
            console.error('Error setting global PersianDatePickerElement:', error);
        }
    }
}
...
//# sourceMappingURL=persian-datepicker-element.min.js.map