var t={};t.d=(e,a)=>{for(var r in a)t.o(a,r)&&!t.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:a[r]})},t.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e);var e={};t.d(e,{a:()=>v});let a={g_days_in_month:[31,28,31,30,31,30,31,31,30,31,30,31],j_days_in_month:[31,31,31,31,31,31,30,30,30,30,30,29],jalaliToGregorian:function(t,e,a){t=parseInt(t.toString()),e=parseInt(e.toString()),a=parseInt(a.toString());let r=t-979,i=e-1,n=a-1,o=365*r+8*Math.floor(r/33)+Math.floor((r%33+3)/4);for(let t=0;t<i;++t)o+=this.j_days_in_month[t];let s=(o+=n)+79,d=1600+400*Math.floor(s/146097),l=!0;(s%=146097)>=36525&&(d+=100*Math.floor(--s/36524),(s%=36524)>=365?s++:l=!1),d+=4*Math.floor(s/1461),(s%=1461)>=366&&(l=!1,d+=Math.floor(--s/365),s%=365);let h=0;for(;s>=this.g_days_in_month[h]+(1===h&&l?1:0);h++)s-=this.g_days_in_month[h]+(1===h&&l?1:0);return[d,h+1,s+1]},gregorianToJalali:function(t,e,a){t=parseInt(t.toString()),e=parseInt(e.toString()),a=parseInt(a.toString());let r=t-1600,i=e-1,n=a-1,o=365*r+Math.floor((r+3)/4)-Math.floor((r+99)/100)+Math.floor((r+399)/400);for(let t=0;t<i;++t)o+=this.g_days_in_month[t];i>1&&(r%4==0&&r%100!=0||r%400==0)&&o++;let s=(o+=n)-79,d=979+33*Math.floor(s/12053)+4*Math.floor((s%=12053)/1461);(s%=1461)>=366&&(d+=Math.floor((s-1)/365),s=(s-1)%365);let l=0;for(;l<11&&s>=this.j_days_in_month[l];++l)s-=this.j_days_in_month[l];return[d,l+1,s+1]},isLeapJalaliYear:function(t){return[1,5,9,13,17,22,26,30].includes(t%33)},getDaysInMonth:function(t,e){return e<1||e>12?0:e<=6?31:e<=11?30:this.isLeapJalaliYear(t)?30:29},getMonthName:function(t){return["فروردین","اردیبهشت","خرداد","تیر","مرداد","شهریور","مهر","آبان","آذر","دی","بهمن","اسفند"][t-1]},getDayOfWeek:function(t,e,a){let r=this.jalaliToGregorian(t,e,a);return new Date(r[0],r[1]-1,r[2]).getDay()},getDaysInYear:function(t){return this.isLeapJalaliYear(t)?366:365},isValidDate:function(t,e,a){return!(t<0)&&!(e<1)&&!(e>12)&&!(a<1)&&a<=this.getDaysInMonth(t,e)}},r={hijriToJalali:function(t,e,a){let[r,i,n]=function(t,e,a){if(e<1||e>12||a<1||a>30)throw Error("Invalid Hijri date");return function(t){let e=Math.floor(t+.5),a=Math.floor((e-1867216.25)/36524.25),r=e+1+a-Math.floor(a/4)+1524,i=Math.floor((r-122.1)/365.25),n=Math.floor(365.25*i),o=Math.floor((r-n)/30.6001),s=Math.floor(r-n-Math.floor(30.6001*o)),d=o-1-12*Math.floor(o/14),l=i-4715-Math.floor((7+d)/10);return d<1&&(d+=12,l-=1),[l,d,s]}(Math.floor((t-1)*354.367)+Math.floor((e-1)*29.5)+(a-1)+1948439.5)}(t,e,a);return function(t,e,a){let r=[31,28,31,30,31,30,31,31,30,31,30,31],i=[31,31,31,31,31,31,30,30,30,30,30,29];t=parseInt(t.toString()),e=parseInt(e.toString()),a=parseInt(a.toString());let n=t%4==0&&t%100!=0||t%400==0;r[1]=n?29:28;for(let t=0;t<e-1;t++)r[t];let o=Math.floor((t+Math.floor((e-8)/6)+100100)*1461/4)+Math.floor(((e+9)%12+1)*153/5)+a-0x2139f58,s=Math.floor(o/1461)-2820+474,d=o%1461;d>=366&&(d-=366,d%=365);let l=0,h=d;for(;h>=i[l];)h-=i[l],l++;return[s,l+1,h+1]}(r,i,n)}},i=[],n=[...i],o={"Persian Calendar":[],"Hijri Calendar":[],Source:{name:"Fallback Data",url:""}},s=!1,d=null,l=null;async function h(){if(s)return l;let t=new Date,e=a.gregorianToJalali(t.getFullYear(),t.getMonth()+1,t.getDate())[0];if(d!==e){s=!0;try{let t=await fetch("data/events.json");if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);o=await t.json(),n=[...function(){try{let t=[];if(o&&Array.isArray(o["Persian Calendar"])&&(t=[...o["Persian Calendar"].map(t=>({title:t.title,month:t.month,day:t.day,type:t.type,holiday:t.holiday}))]),o&&Array.isArray(o["Hijri Calendar"])){let e=o["Hijri Calendar"].map(t=>{let e=r.hijriToJalali(t.year,t.month,t.day);return{title:t.title,month:e[1],day:e[2],type:t.type,holiday:t.holiday,hijri:{year:t.year,month:t.month,day:t.day}}});t=[...t,...e]}return t}catch(t){return console.error("Error mapping calendar events:",t),[...i]}}()],d=e}catch(t){console.error("Error loading events data:",t),n=[...i]}finally{s=!1,l=null}}}class c{static async initialize(){await h()}static getEvents(t,e,a,r=!1){return this.getAllEvents(a,r).filter(a=>a.month===t&&a.day===e)}static getEvent(t,e){return n.find(a=>a.month===t&&a.day===e)}static getEventsForMonth(t){return n.filter(e=>e.month===t)}static getEventsForYear(){return n}static isHoliday(t,e,a,r=!1){return this.getEvents(t,e,a,r).some(t=>!0===t.holiday)}static getHolidayTitles(t,e,a,r=!1){return this.getEvents(t,e,a,r).filter(t=>!0===t.holiday).map(t=>t.title)}static getAllEventTitles(t,e,a,r=!1){return this.getEvents(t,e,a,r).map(t=>t.title)}static getAllEvents(t,e=!1){return e?[...n]:n.filter(e=>t?.includes(e.type)??!0)}static getEventsByType(t,e=!1,a=!1){let r=e?n:n.filter(e=>e.type===t);return a?r.filter(t=>!0===t.holiday):r}static getAllHolidays(t,e=!1){return this.getAllEvents(t,e).filter(t=>!0===t.holiday)}static getEventTypes(){let t=new Set;return n.forEach(e=>t.add(e.type)),Array.from(t)}static getSourceMetadata(){return o.Source||{}}static async refreshEvents(){let t=new Date,e=a.gregorianToJalali(t.getFullYear(),t.getMonth()+1,t.getDate())[0];return d!==e&&await h(),[...n]}}let p=`:host {
  /* Color scheme */
  --jdp-primary: #0891b2;
