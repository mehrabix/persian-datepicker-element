var t={};t.d=(e,a)=>{for(var r in a)t.o(a,r)&&!t.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:a[r]})},t.o=(t,e)=>Object.prototype.hasOwnProperty.call(t,e);var e={};t.d(e,{a:()=>d});let a={g_days_in_month:[31,28,31,30,31,30,31,31,30,31,30,31],j_days_in_month:[31,31,31,31,31,31,30,30,30,30,30,29],jalaliToGregorian:function(t,e,a){t=parseInt(t.toString()),e=parseInt(e.toString()),a=parseInt(a.toString());let r=t-979,i=e-1,n=a-1,s=365*r+8*Math.floor(r/33)+Math.floor((r%33+3)/4);for(let t=0;t<i;++t)s+=this.j_days_in_month[t];let o=(s+=n)+79,d=1600+400*Math.floor(o/146097),l=!0;(o%=146097)>=36525&&(d+=100*Math.floor(--o/36524),(o%=36524)>=365?o++:l=!1),d+=4*Math.floor(o/1461),(o%=1461)>=366&&(l=!1,d+=Math.floor(--o/365),o%=365);let h=0;for(;o>=this.g_days_in_month[h]+(1===h&&l?1:0);h++)o-=this.g_days_in_month[h]+(1===h&&l?1:0);return[d,h+1,o+1]},gregorianToJalali:function(t,e,a){t=parseInt(t.toString()),e=parseInt(e.toString()),a=parseInt(a.toString());let r=t-1600,i=e-1,n=a-1,s=365*r+Math.floor((r+3)/4)-Math.floor((r+99)/100)+Math.floor((r+399)/400);for(let t=0;t<i;++t)s+=this.g_days_in_month[t];i>1&&(r%4==0&&r%100!=0||r%400==0)&&s++;let o=(s+=n)-79,d=979+33*Math.floor(o/12053)+4*Math.floor((o%=12053)/1461);(o%=1461)>=366&&(d+=Math.floor((o-1)/365),o=(o-1)%365);let l=0;for(;l<11&&o>=this.j_days_in_month[l];++l)o-=this.j_days_in_month[l];return[d,l+1,o+1]},isLeapJalaliYear:function(t){return[1,5,9,13,17,22,26,30].includes(t%33)},getDaysInMonth:function(t,e){return e<1||e>12?0:e<=6?31:e<=11?30:this.isLeapJalaliYear(t)?30:29},getMonthName:function(t){return["فروردین","اردیبهشت","خرداد","تیر","مرداد","شهریور","مهر","آبان","آذر","دی","بهمن","اسفند"][t-1]},getDayOfWeek:function(t,e,a){let r=this.jalaliToGregorian(t,e,a);return new Date(r[0],r[1]-1,r[2]).getDay()},getDaysInYear:function(t){return this.isLeapJalaliYear(t)?366:365},isValidDate:function(t,e,a){return!(t<0)&&!(e<1)&&!(e>12)&&!(a<1)&&a<=this.getDaysInMonth(t,e)}},r=[];class i{constructor(){this.mappedEvents=[...r],this.persianCalendarData={"Persian Calendar":[],"Hijri Calendar":[],Source:{name:"Fallback Data",url:""}},this.isLoading=!1,this.lastFetchYear=null,this.fetchPromise=null,this.isInitialized=!1}mapPersianCalendarEvents(){try{let t=[];return this.persianCalendarData&&this.persianCalendarData["Persian Calendar"]&&Array.isArray(this.persianCalendarData["Persian Calendar"])&&(console.log("Processing Persian Calendar events:",{eventCount:this.persianCalendarData["Persian Calendar"].length,sampleEvent:this.persianCalendarData["Persian Calendar"][0]}),t=this.persianCalendarData["Persian Calendar"].map(t=>({title:t.title||"",month:t.month||1,day:t.day||1,type:t.type||"Iran",holiday:t.holiday||!1}))),console.log("Final mapped events:",{totalEvents:t.length,eventTypes:[...new Set(t.map(t=>t.type))],holidayCount:t.filter(t=>t.holiday).length}),t}catch(t){return console.error("Error mapping calendar events:",t),[...r]}}async loadEventsData(){if(this.isLoading)return this.fetchPromise;let t=new Date,e=a.gregorianToJalali(t.getFullYear(),t.getMonth()+1,t.getDate())[0];if(this.isInitialized&&this.lastFetchYear===e){console.log("Using cached events data for year:",e);return}this.isLoading=!0;try{console.log("Attempting to load events.json...");let t=await fetch("data/events.json");if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);this.persianCalendarData=await t.json(),console.log("Successfully loaded events.json:",{hasData:!!this.persianCalendarData,keys:Object.keys(this.persianCalendarData),sampleMonth:Object.entries(this.persianCalendarData).find(([t])=>"Source"!==t&&"#meta"!==t)});let a=this.mapPersianCalendarEvents();console.log("Mapped events:",{totalEvents:a.length,sampleEvent:a[0],eventTypes:[...new Set(a.map(t=>t.type))]}),this.mappedEvents=[...a],this.lastFetchYear=e,this.isInitialized=!0}catch(t){console.error("Error loading events data:",t),this.mappedEvents=[...r]}finally{this.isLoading=!1,this.fetchPromise=null}}async initialize(){await this.loadEventsData()}getEvents(t,e,a,r=!1){return this.getAllEvents(a,r).filter(a=>a.month===t&&a.day===e)}getEvent(t,e){return this.mappedEvents.find(a=>a.month===t&&a.day===e)}getEventsForMonth(t){return this.mappedEvents.filter(e=>e.month===t)}getEventsForYear(){return this.mappedEvents}isHoliday(t,e,a,r=!1){return this.getEvents(t,e,a,r).some(t=>!0===t.holiday)}getHolidayTitles(t,e,a,r=!1){return this.getEvents(t,e,a,r).filter(t=>!0===t.holiday).map(t=>t.title)}getAllEventTitles(t,e,a,r=!1){return this.getEvents(t,e,a,r).map(t=>t.title)}getAllEvents(t,e=!1){return e?[...this.mappedEvents]:this.mappedEvents.filter(e=>t?.includes(e.type)??!0)}getEventsByType(t,e=!1,a=!1){let r=e?this.mappedEvents:this.mappedEvents.filter(e=>e.type===t);return a?r.filter(t=>!0===t.holiday):r}getAllHolidays(t,e=!1){return this.getAllEvents(t,e).filter(t=>!0===t.holiday)}getEventTypes(){let t=new Set;return this.mappedEvents.forEach(e=>t.add(e.type)),Array.from(t)}getSourceMetadata(){return this.persianCalendarData.Source||{}}async refreshEvents(){return this.isInitialized=!1,await this.loadEventsData(),[...this.mappedEvents]}}let n=`:host {
  /* Color scheme */
  --jdp-primary: #0891b2;
      ...
      <div class="picker-container">
        ...
        <div class="calendar" id="calendar">
          <div class="header">
            ...
            ${l?'<button id="next-month" type="button" class="nav-button next"></button>':""}
          </div>
